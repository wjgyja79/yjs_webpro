	...
	<form action="<%=conPath%>/board/updatePro.jsp" method="post">
		...
		<table>
			...
			<tr>
				<th>작성자</th>
				<td>
					<input type="text" name="bname" required="required" value="<%=dto.getBname() %>" 
									autofocus="autofocus">
				</td>
			</tr>
			<tr>
				<th>글제목</th>
				<td>
					<input type="text" name="btitle" required="required" value="<%=dto.getBtitle()%>">
				</td>
			</tr>
			<tr>
				<th>본문</th>
				<td>
					<textarea rows="5" name="bcontent"><%=dto.getBcontent()==null? 
																								"" : dto.getBcontent()%></textarea>
				</td>
			</tr>
			<tr>
				<th>이메일</th>
				<td>
					<input type="email" name="bemail" value="<%
			...
			<tr>
				<th>비밀번호</th>
				<td>
					<input type="password" name="bpw" required="required" value="<%=dto.getBpw()%>">
				</td>
			</tr>
			<tr>
				<td colspan="2">
