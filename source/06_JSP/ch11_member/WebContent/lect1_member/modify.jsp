...
<head>
	...
	<script>
		// submit 이벤트 제한 추가 : pw와 pwChk가 같은지, email 유효성 검사 ...
	</script>
</head>
<body>
<%!
		...
		<table>
			...
			<tr>
				...
				<td>
					<select name="phone1">
						...
						<option <%if("02".equals(phone1)){out.print("selected='selected'");}%>>031</option>
						<option <%if("02".equals(phone1)){out.print("selected='selected'");}%>>032</option>
					</select> -
			...
			<tr>
				...
				<td>
					...
					<%--birth가 Timestamp일 때 <input type="date" name="tempBirth" 
