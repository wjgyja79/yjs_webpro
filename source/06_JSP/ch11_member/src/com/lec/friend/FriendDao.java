...
public class FriendDao {
	...
	// 친구 전부 가져오기
	public ArrayList<FriendDto> listFriends(){
	...
	// 친구 전부 가져오기
	public ArrayList<FriendDto> listFriends(String schName, String schTel){
		ArrayList<FriendDto> dtos = new ArrayList<FriendDto>();
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet         rs    = null;
