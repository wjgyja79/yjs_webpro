...
public class Account {
	...
	public void withdraw(int money) { // 잔액이 있을 경우만 인출. 잔액부족시 오류 출력
		if(balance>=money) {
			balance -= money;
	...
	public void infoprint() { // ["101-1234" 홍길동님 잔액 : 10000원]을 출력
		System.out.println("\""+accountNo + "\" " + ownerName + "님 잔액 : " + balance + "원");
	}
	public String infoString() {// { // ["101-1234" 홍길동님 잔액 : 10000원]을 return
