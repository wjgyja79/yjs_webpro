...
public class Man {
	...
	// 개발자가 생성자 함수를 안만들면 컴파일러는 디폴트 생성자 함수 자동 생성.
	// 개발자가 생성자 함수를 하나이상 만들면 컴파일러는 디폴트 생성자 함수를 안 만들어
	public Man() {
		System.out.println("매개변수 없는 Man 생성자 함수");
	}
	public Man(String name, int age, int hight, double weight) {
		this.name = name;
		this.age = age;
		this.height = height;
		this.weight = weight;
	...
	// 메소드 : BMI지수를 return 하는 메소드 180/68.1 => 68.1/(1.8*1.8)
